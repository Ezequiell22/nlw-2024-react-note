...
export function NewNoteCard( { onNoteCreated } : NewNoteCardProps) {
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger className='rounded-md flex flex-col text-left bg-slate-700 
      p-5 gap-3 hover:ring-2 hover:ring-slate-600 outline-none focus-visible:ring-2 focus-visible:ring-lime-400' >
      ...
      <Dialog.Portal>
        ...
        md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] w-full bg-slate-700 
          ...
          <form className='flex-1 flex flex-col'>
            ...
            {shouldShowOnboarding? (
              ...
              {isRecording ? (
                      ...
                      type='button'
                      className='w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-sm text-slate-300 outline-none 
                      font-medium hover:text-slate-100'>
